...
-- 5. 插入默认会员等级配置
INSERT INTO membership_levels (level_name, level_icon, min_amount, discount_rate, benefits) VALUES
...
-- 7. 插入默认充值金额配置
INSERT INTO recharge_amounts (amount, bonus_amount, sort_order) VALUES
(100.00, 0.00, 1),
(300.00, 30.00, 2),
(500.00, 80.00, 3),
(1000.00, 200.00, 4),
...
-- 14. 插入测试数据（可选）
-- INSERT INTO users (username, email, balance, membership_level) VALUES 
